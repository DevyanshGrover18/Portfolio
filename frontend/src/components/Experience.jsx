  ...
  const experiences = [
    {
      ...
      company: "CodeNap - Professional IT Services",
      companyUrl: "https://www.linkedin.com/company/codenap",
      location: "Faridabad",
      startDate: "March 2026",
      endDate: "Present",
      description:
        "Working across multiple projects simultaneously, diving deep into each codebase to understand its architecture and goals, then providing meaningful feedback to help improve code quality and overall direction.",
      techStack: ["nextjs", "react", "nodejs", "mongodb", "express", "api"],
    },
    {
      id: 2,
      ...
      endDate: "Jan 2024",
      description:
        "Led development of scalable web applications using modern technologies. Collaborated with cross-functional teams to deliver high-quality solutions that improved user experience and business metrics.",
      achievements: [
        ...
        <div className="timeline">
          ...
          {experiences.map((experience, index) => (
            <div
              ...
              key={experience.id}
              style={{ "--card-delay": `${1 + index * 0.18}s` }}
            >
                      ...
                      <ul className="achievements-list">
                        {experience.achievements.map(
                          (achievement, achievementIndex) => (
                            <li key={`${experience.id}-${achievementIndex}`}>
                              <svg viewBox="0 0 24 24" fill="currentColor">
